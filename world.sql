...
--
-- Servidor: localhost
-- Tiempo de generación: 11-09-2017 a las 19:45:18
...
CREATE TABLE `country` (
  ...
  `Continent` enum('Africa','Antartica','Asia','Europe','North America','Oceania','South America') NOT NULL DEFAULT 'Africa',
